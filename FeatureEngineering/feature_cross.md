...
值得说明的是，在上文中“编号12的特征的值为男性在体育广告上面点击率”的方法有待商榷，或者还不够严谨，正确的方法应该是新增一个特征未知比如23，编号12的特征不变，编号23的特征的值为男性在体育广告上面点击率，这个样更加科学。因为23的特征相当于是12的特征细分，而12是粗粒度的特征，粗粒度的特征依然是有意义的。就比如对于FM模型，“男性”特征固然可以用于和“体育”交叉产生CTR特征，但显然舍弃“男性”特征本身是不明智的。
