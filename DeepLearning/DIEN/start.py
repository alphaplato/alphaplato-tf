...
tf.app.flags.DEFINE_string("fcn_layers", '20,10,5', "deep layers")
tf.app.flags.DEFINE_string("auxili_layers", '128,64,32', "auxiliary layers")
tf.app.flags.DEFINE_string("atten_layers", '32,16', "xdeep layers")
tf.app.flags.DEFINE_integer("neg_count", 5, "negative sampling count")
